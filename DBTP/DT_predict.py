...
effective_target = pd.read_csv("../result/DH_target_result.csv",index_col=0)
target_seq = pd.read_csv("./data/human_seq_all.csv",index_col=0)
col_index = [r for r in list(effective_target) if re.search("_target",r)]
...
y_predict_result.to_csv("../result/DH_direct_target.csv")
